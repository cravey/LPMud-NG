# 1 "players/jeff/swroom.c"
# 1 "/home/lpmud/mudlib/room/room.h"
inherit "room/room";
...
reset(arg) { if (!arg) { set_light( 1); short_desc =  	 "The sword room"; long_desc =  	 "You are in the room of the black sword.\n"; dest_dir = ({ "room/ruin",  "south" }); } fix_sword(); }
# 32 "players/jeff/swroom.c"
