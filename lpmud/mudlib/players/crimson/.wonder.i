# 1 "players/crimson/.wonder.c" 
# 1 "/home/einstein/mud/lpmud/mudlib/room/../../security.h" 1
...
init() {
    if (!new_object && call_other(this_player(), "query_level") >= 20) {
