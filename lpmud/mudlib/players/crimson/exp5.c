...
id(str) { 
    return str == "potion of healing" || str == "potion of heal" || str == "potion";
}
...
object flask;
   ...
   if (str == "potion" || str == "potion of healing" || str == "potion of heal") {
   write("You quaff down the orange potion.\n");
...
read(str) {
  if (str == "label" && i == 0 || str == "label on orange potion" && i == 0) {
  write("The label reads: Potion of Healing.\n");
  return 1;
  } else
  if (!str) {
  return 0;
