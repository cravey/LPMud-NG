...
ONE_EXIT("players/ringer/crlair", "west",
	   "You are in chromatic dragon's treasure room",
"You are in the chromatic dragon's treasure room!\n",1)
...
ex_reset() {
    ...
    if (!present("copper wand")) {
        item = clone_object("players/ringer/spitem");
        call_other(item,"set_id","copper wand");
        ...
        call_other(item,"set_short","A copper wand");
