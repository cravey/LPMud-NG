...
reset(){
    ...
    if (n==9) {found1=1; red="north";}
    if (n==1) {found2=1; blue="north";}
    s = random(5-found1)+5;
    if (found1 && s==8) s=1;
    sd="south#"+call_other("players/ringer/pyramid/nmaze1","give_dest",s);
    if (s==9) {found1=1; red="south";}
    if (s==1) {found2=1; blue="south";}
    e = random(5-found1)+5;
    if (found1 && e==8) e=8;
    de="east#"+call_other("players/ringer/pyramid/nmaze1","give_dest",e);
    if (e==9) {found1=1; red="east";}
    if (e==1) {found2=1; blue="east";}
    w = random(5-found1)+5;
    if (found1 && w==8) w=1;
    wd="west#"+call_other("players/ringer/pyramid/nmaze1","give_dest",w);
    if (w==9) {found1=1; red="west";}
    if (w==1) {found2=1; blue="west";}
    u = random(5-found1)+5;
    if (!found2) u=1;
    ud="up#"+call_other("players/ringer/pyramid/nmaze1","give_dest",u);
    if (u==9) {found1=1; red="up";}
    if (u==1) {found2=1; blue="up";}
    if (!found1) {d=9; red="down";} else d = random(9);
    if (d==1) d+=2;
