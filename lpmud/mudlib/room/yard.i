...
reset(arg) { if (!arg) { set_light( 1); short_desc =  	 "Small yard"; long_desc =  	 "A small yard surrounded by houses.\n"; dest_dir = ({ "room/vill_road1",  "south",  	 "room/pub2",  "east" }); } extra_reset(); }
# 63 "room/yard.c"
