...
heart_beat()
{
	...
	if (players[j + 1] == 5)
	{
	    ...
	    tell_object(players[j], "Death says: " + "IT IS TIME\n");
...
# 108 "room/death/death_room.c"
	...
	if (players[j + 1] == 10)
	{
	    ...
	    tell_object(players[j], "Death says: " + "NO GLANDS, THAT'S WHY.\n");
...
# 117 "room/death/death_room.c"
	...
	if (players[j + 1] == 15)
	{
	    ...
	    tell_object(players[j], "Death says: " + "WITHOUT GLANDS YOU FEEL NOTHING, NOTHING AT ALL.\n");
...
# 126 "room/death/death_room.c"
	...
	if (players[j + 1] == 20)
	{
	    ...
	    tell_object(players[j], "Death says: " + "COME HERE, I MUST READ YOUR SOUL.\n");
...
# 141 "room/death/death_room.c"
	...
	if (players[j + 1] == 30)
	{
	    ...
	    if(align < -1000)
	    {
		tell_object(players[j], "Death says: " + "YOUR SINS ARE AS MANY AS THE GRAINS OF SAND IN THE DESERT.\n" + 		      "MAYBE YOU'RE WORSE A MONSTER THAN I! HAHAHAHAHA!\n\n");
# 153 "room/death/death_room.c"
		continue;
	    }
	    
	    if(align < -500)
	    {
		tell_object(players[j], "Death says: " + "OH WHAT A DESPISABLE BUG WE HAVE HERE. STEALING CANDY FROM\n" + 		      "BABIES AND BEATING OLD LADIES NO DOUBT. WELL NOW THEY CAN DANCE\n" + 		      "ON YOUR GRAVE. HAHAHA!\n\n");
# 161 "room/death/death_room.c"
		continue;
	    }
	    
	    if(align < -200)
	    {
		tell_object(players[j], "Death says: " + "HAVE YOU EVER BEEN TOLD ABOUT REPENTANCE AND ATONEMENT? NO?\n" + 		      "DIDN'T THINK SO EITHER. YOU WILL BE TOLD NOW HOWEVER,\n" + 		      "FOR ETERNITY! HAHAHA!\n\n");
# 169 "room/death/death_room.c"
		continue;
	    }
	    
	    if(align < 0)
	    {
		tell_object(players[j], "Death says: " + "SHAME ON YOU MORTAL ONE! STEALING AND KILLING, IS THAT ALL\n" + 		      "YOU CAN THINK OF? WELL NOW YOU WILL BE GIVEN TIME TO REGRET YOUR\n" + 		      "DEEDS. FOR EVER, HAHA!\n\n");
# 177 "room/death/death_room.c"
		continue;
	    }
	    
	    if(align == 0)
	    {
		tell_object(players[j], "Death says: " + "WHAT A FENCE-CLIMBER WE HAVE HERE! NEVER MADE UP YOUR MIND\n" + 		      "IN ALL YOUR LIFE, DID YOU? WELL, DON'T WORRY. YOU WON'T HAVE TO\n" + 		      "NOW EITHER! HAHAHA!\n\n");
# 185 "room/death/death_room.c"
		continue;
	    }
	    
	    if(align < 200)
	    {
		tell_object(players[j], "Death says: " + "OH WHAT A NICE FELLOW WE HAVE HERE. ALWAYS WALKING THE NARROW\n" + 		      "ROAD, DID YOU? WELL, YOU'LL NEVER KNOW WHAT THE OTHER ROAD IS LIKE\n"  + 		      "NOW! HAHAHA!\n\n");
# 193 "room/death/death_room.c"
		continue;
	    }
	    
	    if(align < 500)
	    {
		tell_object(players[j], "Death says: " + "NEVER SAID A DIRTY WORD IN YOUR LIFE DID YOU? WELL, IT'S TOO\n" + 		      "LATE TO CHANGE YOUR MIND ABOUT THAT NOW. HAHAHA! NO MR NICE-GUY YOU\n" + 		      "ARE WHAT YOU WERE. HAHAHA!\n\n");
# 201 "room/death/death_room.c"
		continue;
	    }
	    
	    if(align < 1000)
	    {
		tell_object(players[j], "Death says: " + "I HEARD THEY WERE OUT OF ARCHANGELS IN HEAVEN. PERHAPS YOU\n" + 		      "SHOULD APPLY FOR THE JOB? I HOPE YOU KNOW HOW TO PLAY THE HARP,\n" + 		      "OR THEY'LL GIVE THE JOB TO SOMEONE ELSE! HAHAHA!\n\n");
# 209 "room/death/death_room.c"
		continue;
	    }
	    
	    tell_object(players[j], "Death says: " + "TRYING TO TAKE THE JOB AWAY FROM GOD, ARE YOU? HAHAHA! LET ME TELL\n" + 		  "YOU A BIT ABOUT IT BEFORE YOU SIGN ANY PAPERS THOUGH. BAD HOURS AND NO\n" + 		  "VACATION. BELIEVE ME, YOU DON'T WANT IT!\n\n");
# 215 "room/death/death_room.c"
	...
	if (players[j + 1] == 35)
	{
	    ...
	    tell_object(players[j], "Death says: " + "WELL, I GUESS YOU HAVE DONE YOURS FOR THIS TIME, SEE YOU ON\n" + 		  "ARMAGEDDON DAY! HAHAHAHAHAHAHAHAHAHAHAHAHAHAHAHAHAHAHA!\n\n");
# 223 "room/death/death_room.c"
	    tell_object(players[j], "Death removes the orb from his eye and stands up. Suddenly he turns and walks\n" + 		  "out of the room through the nearest wall, still holding you in his skeletal\n" + 		  "hand! He walks rapidly through a dark winding corridor, down a staircase to\n" + 		  "the innermost room in the bottom of the cellar. Finally he stops in front of a\n" + 		  "door bearing the words 'ETERNITY' in black letters. On the door you can see a\n" + 		  "small hatch which Death opens with a flick of his hand. From the open hatch\n" + 		  "you can hear the moaning murmurs of a million souls. Slowly he lifts you to\n" + 		  "the gaping maw of the hatch.\n\n");
# 231 "room/death/death_room.c"
	}
	
	if (players[j + 1] == 40)
	    tell_object(players[j], "Ciaran arrives through a rift in the fabric of space.\n");
	
	if (players[j + 1] == 45) {
	    tell_object(players[j], "Ciaran smiles at you.\n");
	}
	if (players[j + 1] == 47)
	{
	    tell_object(players[j], "Ciaran whispers something to Death.\n");
	}
	
	if (players[j + 1] == 54)
	{
	    tell_object(players[j], "Death says: " + "WHAT? OUT OF THE QUESTION! YOU KNOW THAT!\n\n");
	}
	if (players[j + 1] == 56)
	{
	    tell_object(players[j], "Ciaran sighs deeply.\n");
	}
	if (players[j + 1] == 58)
	{
	    tell_object(players[j], "Ciaran whispers something to Death.\n");
	...
	if (players[j + 1] == 60)
	{
	    tell_object(players[j], "Death says: " + "REINCARNATION? FOR THIS ONE? HE IS NOT WORTHY OF THAT!\n" + 		  "PLEASE BE SENSIBLE CIARAN!\n\n");
# 261 "room/death/death_room.c"
	}
	if (players[j + 1] == 62) {
	    tell_object(players[j], "Ciaran sulks in the corner.\n");
	    tell_object(players[j], "Ciaran leaves through a rift in the fabric of space.\n");
	    tell_object(players[j], "Death looks at you with something that must be disgust even if it's hard to\n" + 		  "say. His face is not the best suited face for showing expressions, but\n" + 		  "you feel fairly confident about this one.\n\n");
# 268 "room/death/death_room.c"
	}
	
	if (players[j + 1] == 70)
	{
	    
	    tell_object(players[j], "Death says: " + "OH ALL RIGHT THEN! I CAN WAIT. ONE DAY YOU WILL BE MINE ANYWAY!\n\n");
	    tell_object(players[j], "Suddenly Death hurles you up in the air, you feel a strange sensation as you\n" + 		  "pass through the very walls of the building, out in the open air, through some\n" + 		  "other walls and fairly surprised horses before you finally stop inside another\n" + 		  "building. It seems vaguely familiar...\n");
# 278 "room/death/death_room.c"
