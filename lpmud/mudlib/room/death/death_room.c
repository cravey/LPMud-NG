...
heart_beat()
{
	...
	if (players[j + 1] == 40)
	    WRITE("Ciaran arrives through a rift in the fabric of space.\n");
	
	if (players[j + 1] == 45) {
	    WRITE("Ciaran smiles at you.\n");
	}
	if (players[j + 1] == 47)
	{
	    WRITE("Ciaran whispers something to Death.\n");
	}
	...
	if (players[j + 1] == 62) {
	    WRITE("Ciaran sulks in the corner.\n");
	    WRITE("Ciaran leaves through a rift in the fabric of space.\n");
