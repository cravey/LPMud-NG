...
static void build_block(u *ptr, u size) {		/* build a properly annotated unalloc block */
...
int resort_free_list(void) { return 0; }
 ...
 */
void *calloc(size_t nelem, size_t sizel)
{
    char *p;
